...
export const CATS_INCOME: Category[] = [
  ...
  { id: '환급금', icon: 'refund', bg: '#EBFAF5', fg: '#00B493' },
...
export const CATS_TRANSFER: Category[] = [
  ...
  { id: '연금', icon: 'pension', bg: '#EBFAF5', fg: '#00B493' },
  { id: '대출상환', icon: 'money', bg: '#EBFAF5', fg: '#00B493' },
  { id: '자산회수', icon: 'wallet', bg: '#FFF0EB', fg: '#F06A00' },
  { id: '기타', icon: 'other', bg: '#F2F4F6', fg: '#8B95A1' },
];
